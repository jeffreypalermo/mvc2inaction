...
<%@ Page Language="vb" AutoEventWireup="true" Inherits="SamplesVB.CustomProgress._Default" CodeBehind="Default.aspx.vb" %>
<kw:BeforeContent runat="server" Title="Custom Progress" id="BeforeContent1" />
...
<form runat="server">
	<div ID="uploadPanel" runat="server">
		...
		<kw:SlickUpload ID="SlickUpload1" runat="server" ShowDuringUploadElements="cancelLink" HasPostProcessStep="true"
			onuploadcomplete="SlickUpload1_UploadComplete" UploadUrl="~/CustomProgress/SlickUpload.axd"
			OnClientProgressUpdate="SlickUpload_OnClientProgressUpdate">
			...
			<ProgressTemplate>
				...
				<table width="99%" id="postProcessProgress" style="display:none">
					...
					<tr>
						<td>
							<div style="border: 1px solid #008800; height: 1.5em; position: relative">
								<kwp:ProgressBarElement id="UploadProgressBarElement2" runat="server" Style="background-color: #00ee00; width: 0; height: 1.5em"
									ElementKey="percentComplete" />
								<div style="text-align: center; position: absolute; top: .15em; width: 100%">
									<kwp:ProgressElement id="UploadProgressElement9" runat="server" ElementKey="percentCompleteText">(calculating)</kwp:ProgressElement>
								</div>
							</div>
						</td>
					</tr>
