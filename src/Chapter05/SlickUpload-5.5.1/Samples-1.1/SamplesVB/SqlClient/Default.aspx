...
<%@ Import Namespace="SamplesVB.SqlClient" %>
...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="SamplesVB.SqlClient._Default" CodeBehind="Default.aspx.vb" %>
...
<form runat="server" ID="Form1">
	...
	<asp:Repeater ID="filesRepeater" runat="server">
		...
		<ItemTemplate>
			<tr>
				<td>
					<a href="DownloadFile.ashx?id=<%#DirectCast(Container.DataItem, RepositoryFile).Id%>">
						<%#DirectCast(Container.DataItem, RepositoryFile).Name%>
					</a>
				</td>
				<td>
					<%#DirectCast(Container.DataItem, RepositoryFile).Length%>
				</td>
			</tr>
		</ItemTemplate>
		<FooterTemplate>
