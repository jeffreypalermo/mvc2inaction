...
<%@ Register Assembly="Krystalware.SlickUpload" Namespace="Krystalware.SlickUpload.Controls"
    TagPrefix="kw" %>
<%@ Import Namespace="SamplesVB.CustomUploadStreamProvider" %>
...
<%@ Page Language="vb" AutoEventWireup="true" Inherits="SamplesVB.CustomUploadStreamProvider._Default" CodeBehind="Default.aspx.vb" %>
...
<form runat="server" ID="Form1">
	<div ID="uploadPanel" runat="server">
		...
		<kw:SlickUpload ID="SlickUpload1" runat="server" ShowDuringUploadElements="cancelLink" onuploadcomplete="SlickUpload1_UploadComplete"
			UploadUrl="~/CustomUploadStreamProvider/SlickUpload.axd">
		...
		<asp:Repeater ID="resultsRepeater" runat="server">
			...
			<ItemTemplate>
				<tr>
					...
					<td>~<%#DirectCast(Container.DataItem, UploadedFile).LocationInfo(ZipUploadStreamProvider.FileNameKey).Substring(Server.MapPath("~/").Length - 1).Replace("\"c, "/"c)%></td>
