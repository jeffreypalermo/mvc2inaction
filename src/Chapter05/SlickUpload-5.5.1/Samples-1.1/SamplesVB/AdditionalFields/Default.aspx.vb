...
#End Region
        ...
        Protected Function SerializeDictionaryToString(ByVal values As NameValueCollection) As String
            Dim sb As StringBuilder = New StringBuilder

            For Each key As String In values
                If sb.Length > 0 Then
                    sb.Append("<br />")
                End If
                ...
                sb.Append(key)
                sb.Append(": ")
                sb.Append(values(key).Replace(vbNewLine, "<br />"))
            Next key
