<%@ Page Language="c#" AutoEventWireup="true" Inherits="SamplesCS.CustomUploadStreamProvider.Default" CodeBehind="Default.aspx.cs" %>
...
<%@ Import Namespace="SamplesCS.CustomUploadStreamProvider" %>
...
<kw:BeforeContent runat="server" Title="Custom UploadStreamProvider" id="BeforeContent1" />
    ...
    <div ID="uploadPanel" runat="server">
        ...
        <kw:SlickUpload ID="SlickUpload1" runat="server" 
            ...
            onuploadcomplete="SlickUpload1_UploadComplete" UploadUrl="~/CustomUploadStreamProvider/SlickUpload.axd">
        ...
        <asp:Repeater ID="resultsRepeater" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>~<%#((UploadedFile)Container.DataItem).LocationInfo[ZipUploadStreamProvider.FileNameKey].Substring(Server.MapPath("~/").Length - 1).Replace('\\', '/')%></td>
