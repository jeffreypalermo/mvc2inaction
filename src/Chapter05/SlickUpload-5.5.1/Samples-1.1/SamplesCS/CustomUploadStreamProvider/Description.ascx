...
<p>This sample demonstrates an UploadStreamProvider that zips all files as they are uploaded. The configuration is as follows:</p>
    <kw:Source Type="Html" runat="server"><uploadStreamProvider provider="Custom" location="~/CustomUploadStreamProvider/Files/" type="SamplesCS.CustomUploadStreamProvider.ZipUploadStreamProvider, SamplesCS" /></kw:Source>
