...
<%@ Page Language="c#" AutoEventWireup="true" Inherits="SamplesCS.Simple.Default" CodeBehind="Default.aspx.cs" %>
<kw:BeforeContent runat="server" Title="Simple" id="BeforeContent1" />
    ...
    <div ID="uploadPanel" runat="server">
        ...
        <kw:SlickUpload ID="SlickUpload1" runat="server" 
            ...
            onuploadcomplete="SlickUpload1_UploadComplete" UploadUrl="~/Simple/SlickUpload.axd">
