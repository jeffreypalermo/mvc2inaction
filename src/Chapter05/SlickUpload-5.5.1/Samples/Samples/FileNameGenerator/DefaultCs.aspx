<%@ Page Title="FileNameGenerator" Language="C#" MasterPageFile="~/Common/Site.master" AutoEventWireup="true" CodeFile="DefaultCS.aspx.cs" Inherits="FileNameGenerator_DefaultCs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <asp:Panel ID="uploadPanel" runat="server">
        ...
        <kw:SlickUpload ID="SlickUpload1" runat="server" 
            ...
            onuploadcomplete="SlickUpload1_UploadComplete" UploadUrl="~/FileNameGenerator/SlickUpload.axd">
        ...
        <asp:Repeater ID="resultsRepeater" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>~<%#((UploadedFile)Container.DataItem).LocationInfo[FileUploadStreamProvider.FileNameKey].Substring(Server.MapPath("~/").Length - 1).Replace('\\', '/')%></td>
