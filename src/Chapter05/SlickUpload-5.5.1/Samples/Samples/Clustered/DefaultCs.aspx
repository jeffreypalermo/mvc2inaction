<%@ Page Title="Clustered" Language="C#" MasterPageFile="~/Common/Site.master" AutoEventWireup="true" CodeFile="DefaultCS.aspx.cs" Inherits="Clustered_DefaultCs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <asp:Panel ID="uploadPanel" runat="server">
        ...
        <kw:SlickUpload ID="SlickUpload1" runat="server" 
            ...
            onuploadcomplete="SlickUpload1_UploadComplete" UploadUrl="~/Clustered/SlickUpload.axd">
