<%@ Page Title="Custom UploadStreamProvider" Language="C#" MasterPageFile="~/Common/Site.master" AutoEventWireup="true" CodeFile="DefaultCS.aspx.cs" Inherits="CustomUploadStreamProvider_DefaultCs" %>
        ...
        <asp:Repeater ID="resultsRepeater" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>~<%#((UploadedFile)Container.DataItem).LocationInfo[ZipUploadStreamProviderCS.FileNameKey].Substring(Server.MapPath("~/").Length - 1).Replace('\\', '/')%></td>
