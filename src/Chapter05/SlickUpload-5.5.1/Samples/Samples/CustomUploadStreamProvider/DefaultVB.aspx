<%@ Page Title="Custom UploadStreamProvider" Language="VB" MasterPageFile="~/Common/Site.master" AutoEventWireup="false" CodeFile="DefaultVB.aspx.vb" Inherits="CustomUploadStreamProvider_DefaultVB" %>
        ...
        <asp:Repeater ID="resultsRepeater" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>~<%#DirectCast(Container.DataItem, UploadedFile).LocationInfo(ZipUploadStreamProviderVB.FileNameKey).Substring(Server.MapPath("~/").Length - 1).Replace("\"c, "/"c)%></td>
