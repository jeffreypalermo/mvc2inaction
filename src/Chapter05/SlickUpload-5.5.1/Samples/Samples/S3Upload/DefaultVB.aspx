<%@ Page Title="S3 Upload" Language="VB" MasterPageFile="~/Common/Site.master" AutoEventWireup="false" CodeFile="DefaultVB.aspx.vb" Inherits="S3Upload_DefaultVB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <asp:Panel ID="uploadPanel" runat="server">
        ...
        <kw:SlickUpload ID="SlickUpload1" runat="server" 
            ...
            UploadUrl="~/S3Upload/SlickUpload.axd" OnClientProgressUpdate="SlickUpload_OnClientProgressUpdate">
