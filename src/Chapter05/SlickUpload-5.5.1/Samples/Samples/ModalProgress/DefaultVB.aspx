<%@ Page Title="Modal Progress" Language="VB" MasterPageFile="~/Common/Site.master" AutoEventWireup="false" CodeFile="DefaultVB.aspx.vb" Inherits="ModalProgress_DefaultVB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <asp:Panel ID="uploadPanel" runat="server">
        ...
        <kw:SlickUpload ID="SlickUpload1" runat="server" 
            ...
            UploadUrl="~/ModalProgress/SlickUpload.axd" OnClientUploadStarted="showProgressModal">
