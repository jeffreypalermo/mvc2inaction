...
<h2>Confirm navigate message</h2>
<p>
...
<kw:Source ID="Source8" Type="Html" runat="server"><kw:SlickUpload ... ConfirmNavigateDuringUploadMessage="Leaving will cancel the current upload!" ... /></kw:Source>
