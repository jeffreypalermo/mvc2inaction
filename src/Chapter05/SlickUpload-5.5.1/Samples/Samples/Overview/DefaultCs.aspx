<%@ Page Title="Overview" Language="C#" MasterPageFile="~/Common/Site.master" AutoEventWireup="true" CodeFile="DefaultCS.aspx.cs" Inherits="Overview_DefaultCs" %>
        ...
        <div style="border:solid 1px #ccc;padding:.5em;margin-bottom:1em;" id="Div1" runat="server">
            <table class="settings">
                <tbody>
                    ...
                    <tr>
                        <td>
        <kw:SlickUpload ID="SlickUpload1" runat="server" ConfirmNavigateDuringUploadMessage
